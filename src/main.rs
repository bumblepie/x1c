...
const ALL_CONTINENTS: [Continent; 3] = [Continent::America, Continent::Africa, Continent::Eurasia];
...
impl Prompt {
    fn must_come_after(&self, other: &Prompt) -> bool {
        match self {
...
fn random_continent<R>(rng: &mut R) -> Continent
where
    R: Rng,
{
