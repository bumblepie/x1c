...
impl RulebookSection {
    ...
    pub fn title(&self) -> String {
        match self {
            ...
            Self::AlienThreatConsequences => "Alien Threat and Tasks",
            Self::Interceptors => "Interceptors",
            Self::UFODefense => "UFO Defense",
            Self::ResearchAndTech => "Research and Technology",
            Self::ResearchTask => "Research and Technology",
